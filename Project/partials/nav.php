...
<ul class="nav">
	...
	<div class="dropdown">
	<button style="float:right" class="dropbtn">Products Test<i class="fa fa-caret-down"></i></button>
	...
	<div class="dropdown">
	<button style="float:right" class="dropbtn">Cart Test<i class="fa fa-caret-down"></i></button>
	<div class="dropdown-content">
