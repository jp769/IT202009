...
<ul class="nav">
    ...
    <?php if (!is_logged_in()): ?>
        <li><a href=<?php getURL("login.php");?>>Login</a></li>
        <li><a href=<?php getURL("register.php");?>>Register</a></li>
    <?php endif; ?>
    <?php if (is_logged_in()): ?>
        <li><a href=<?php getURL("profile.php");?>>Profile</a></li>
        <li style="float:right"><a class="active" href=<?php getURL("logout.php");?>>Logout</a></li>
    <?php endif; ?>
